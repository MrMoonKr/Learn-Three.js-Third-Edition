...
class OrbitControllerGizmo {

    /**
     * 
     * @param {OrbitController} orbitController 
     * @param {*} options 
     */
    constructor( orbitController, options ) {
        ...
        const camera = orbitController.object;
