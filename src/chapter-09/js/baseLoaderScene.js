 ...
 */
export function BaseLoaderScene( providedCamera, shouldAddLights, shouldRotate, updateMesh ) {
    ...
    this.shouldRotateCheck = ( shouldRotate !== undefined ) ? shouldRotate : true;
    this.updateMeshFunction = updateMesh
    ...
    this._render = function () {
        ...
        if ( self.updateMeshFunction ) {
            self.updateMeshFunction( self.mesh )
        }

        if ( self.shouldRotateCheck ) {
