...
function init() 
{
    ...
    var controls = {
        ...
        warp: function () {
            clipAction.warp( controls.warpStartTimeScale, controls.warpEndTimeScale, controls.warpDurationInSeconds )
        },
        fadeDurationInSeconds: 2,
        fadeIn: function () {
            clipAction.fadeIn( controls.fadeDurationInSeconds )
        },
        fadeOut: function () {
            clipAction.fadeOut( controls.fadeDurationInSeconds )
        },
        effectiveWeight: 0,
    ...
    function enableControls() {
        ...
        mixerFolder.add( controls, "timeScale", 0, 5 ).onChange( function ( timeScale ) {
        ...
        actionFolder.add( clipAction, "loop", {
        ...
        gui.add( controls, "keyframe", 0, 15 ).step( 1 ).onChange( function ( frame ) {
            showFrame( frame );
        } );
    }
