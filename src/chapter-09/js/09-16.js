...
function init() 
{
    ...
    var loader = new XLoader( manager, textureLoader );
    var animLoader = new XLoader( manager, textureLoader );
    ...
    loader.load( [ "../../assets/models/x/SSR06_model.x" ], function ( result ) {
        ...
        animLoader.load( [ "../../assets/models/x/stand.x", {
            ...
            mixerFolder.add( mixerControls, "timeScale", 0, 20 ).onChange( function ( timeScale ) {
